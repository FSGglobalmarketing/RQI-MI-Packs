    ...
    <div className="space-y-2 mt-3">
      ...
      {isVideo && (
        <>
          ...
          <div className="flex items-center justify-between text-[10px] text-white px-1 pt-0.5">
...
function Metric({ label, value, highlight }: { label: string; value: string; highlight?: boolean }) {
  return (
    <div className="rounded-lg bg-foreground/[0.06] py-2 px-1">
      ...
      <p className="text-[9px] text-white mt-0.5">{label}</p>
    </div>
  );
}
  ...
  return (
    <div className="w-full max-w-2xl mx-auto space-y-3">
      ...
      <div className="flex items-center justify-between">
        <h4 className="text-xs font-bold uppercase tracking-wider text-white">Ad Creatives</h4>
      ...
      <div className="rounded-xl border border-foreground/10 overflow-hidden bg-foreground/[0.03] p-2.5">
        ...
        <div className="flex items-center gap-2 mt-3 px-0.5">
          ...
          {ad.duration && (
            <span className="text-[9px] font-bold uppercase tracking-wider text-white bg-foreground/10 px-1.5 py-0.5 rounded shrink-0">
              {ad.duration}
            </span>
          )}
        </div>
