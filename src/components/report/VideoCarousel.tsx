          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[10px] text-white mt-0.5">Total views</p>
              </div>
            </div>
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-[10px] text-white mt-0.5">Avg completion</p>
              </div>
            </div>
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-[10px] text-white mt-0.5">Peak engagement</p>
              </div>
            </div>
          </div>
        </div>
