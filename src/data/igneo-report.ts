...
export const reportData = {
  ...
  events: {
    ...
    list: [
      ...
      { name: "CFA Quebec Winter Event", format: "Conference", audience: "Institutional", region: "NA", quarter: "Q1", status: "committed" as const, category: "Conference", city: "Quebec", lat: 46.8139, lng: -71.2080, startDate: "2026-02-04", endDate: "2026-02-05", brand: "Igneo", marketingLead: "Sophie Haynes", distributionLead: "Elizabeth Altman" },
      { name: "Infralogic Investor Forum", format: "Conference", audience: "Institutional", region: "ANZ", quarter: "Q1", status: "committed" as const, category: "Conference", city: "Sydney", lat: -33.8688, lng: 151.2093, startDate: "2026-03-03", brand: "Igneo", host: "ION Analytics", marketingLead: "Phoebe Reardon", sponsorshipCost: 32000, currency: "AUD" },
      { name: "Infrastructure Investor Global Summit", format: "Conference", audience: "Institutional", region: "CE", quarter: "Q1", status: "committed" as const, category: "Conference", city: "Berlin", lat: 52.52, lng: 13.405, startDate: "2026-03-24", endDate: "2026-03-27", brand: "Igneo", hasSpeakingSlot: true, speaker: "Carolyn, Hamish, Gregor", marketingLead: "Mandy Ashmore", distributionLead: "Pete Swan / Sasha Beisheim" },
      { name: "Private Wealth Investment Leaders Forum", format: "Conference", audience: "Wholesale", region: "ANZ", quarter: "Q1", status: "committed" as const, category: "Conference", city: "Sydney", lat: -33.8688, lng: 151.2093, startDate: "2026-03-13", brand: "Igneo", host: "GII", hasSpeakingSlot: true, marketingLead: "Phoebe Reardon", sponsorshipCost: 40000, currency: "AUD" },
      { name: "Entireti Alliances Conference", format: "Conference", audience: "Wholesale", region: "ANZ", quarter: "Q1", status: "distribution-owned" as const, category: "Conference", city: "Queenstown", lat: -45.0312, lng: 168.6626, startDate: "2026-03-15", endDate: "2026-03-17", brand: "Igneo", host: "Entireti", speaker: "Marc B", assetClass: "AEQ, RQI, SMIDS, Igneo", sponsorshipCost: 1500, currency: "AUD" },
      { name: "Centrepoint Alliances Conference", format: "Conference", audience: "Wholesale", region: "ANZ", quarter: "Q1", status: "distribution-owned" as const, category: "Conference", city: "Christchurch", lat: -43.5321, lng: 172.6362, startDate: "2026-03-18", brand: "Igneo", host: "Centerpoint", sponsorshipCost: 1500, currency: "AUD", comments: "Marketing only contributes to stand build" },
      ...
      { name: "Morningstar Investment Conference", format: "Conference", audience: "Wholesale", region: "ANZ", quarter: "Q2", status: "committed" as const, category: "Conference", city: "Sydney", lat: -33.8688, lng: 151.2093, startDate: "2026-05-19", endDate: "2026-05-20", brand: "Igneo", hasSpeakingSlot: true, assetClass: "Igneo", marketingLead: "Karyn Arthur", distributionLead: "Brodie Paape", sponsorshipCost: 20500, currency: "AUD", comments: "$4.5k contribution to FSG sponsorship + $16k for networking drinks" },
      ...
      { name: "PEI Tokyo Forum", format: "Conference", audience: "Institutional", region: "ASIA", quarter: "Q2", status: "proposed" as const, category: "Conference", city: "Tokyo", lat: 35.6762, lng: 139.6503, startDate: "2026-06-04", endDate: "2026-06-05", brand: "Igneo", hasSpeakingSlot: true, speaker: "Danny", sponsorshipCost: 20000, currency: "AUD" },
      ...
      { name: "SuperReturns", format: "Conference", audience: "Institutional", region: "ASIA", quarter: "Q3", status: "proposed" as const, category: "Conference", city: "Singapore", lat: 1.3521, lng: 103.8198, startDate: "2026-09-01", brand: "Igneo", marketingLead: "Edward Tang", distributionLead: "Marcus Ong" },
      ...
      { name: "Institutional Connect Infrastructure Forum", format: "Forum", audience: "Institutional", region: "NA", quarter: "Q4", status: "committed" as const, category: "Conference", city: "Toronto", lat: 43.6532, lng: -79.3832, startDate: "2026-10-01", brand: "Igneo", hasSpeakingSlot: true, marketingLead: "Sophie Haynes", distributionLead: "Elizabeth Altman" },
      { name: "Investment Leaders Forum INASIA", format: "Conference", audience: "Institutional", region: "ANZ", quarter: "Q4", status: "proposed" as const, category: "Conference", city: "Singapore", lat: 1.3521, lng: 103.8198, startDate: "2026-11-26", endDate: "2026-11-27", brand: "Igneo" },
