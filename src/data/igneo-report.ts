...
export const reportData = {
  ...
  website: {
    ...
    kpis: [
      { value: "29.3k", label: "Active users", comparison: "Q1 2026" },
      { value: "39.3k", label: "Page views", comparison: "Q1 2026" },
    ],
    goals: [
    ...
    gaMonthly: [
      { month: "Jan 26", users: 19137, sessions: 25529, pageViews: 25529, bounceRate: 40, avgDuration: 72 },
      { month: "Feb 26", users: 5013, sessions: 6552, pageViews: 6552, bounceRate: 42, avgDuration: 68 },
      { month: "Mar 26", users: 5165, sessions: 7172, pageViews: 7172, bounceRate: 38, avgDuration: 75 },
    ],
    topPages: [
      { page: "/sg/.../rqi-investors", views: 18020, change: "SG Retail" },
      { page: "/au/.../rqi-investors", views: 17430, change: "AU Adviser" },
      { page: "/hk/zh/.../rqi-investors", views: 15739, change: "HK Retail (ZH)" },
      { page: "/hk/en/.../rqi-investors", views: 8758, change: "HK Retail (EN)" },
      { page: "/au/.../team-members", views: 1044, change: "AU Team" },
    ],
    trafficSources: [
